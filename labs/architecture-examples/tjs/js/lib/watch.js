...
(function (factory) {
    ...
    var watchAll = function (obj, watcher, level, addNRemove) {
        ...
        if(isArray(obj)) {
            ...
            for (var prop2 in obj) { //for each attribute if obj is an object
                if (obj.watchIgnore && obj.watchIgnore.indexOf(prop2) >= 0) continue;
    ...
    var watchOne = function (obj, prop, watcher, level, addNRemove) {
        ...
        if (obj.watchIgnore && obj.watchIgnore.indexOf(prop) >= 0) {
            return;
        }
    ...
    var defineWatcher = function (obj, prop, watcher) {
        ...
        var setter = function (newval) {
            ...
            if (!WatchJS.noMore){
                //if (JSON.stringify(oldval, true) !== JSON.stringify(newval, true)) {
                if (stringifyOnce(oldval) !== stringifyOnce(newval)) {
